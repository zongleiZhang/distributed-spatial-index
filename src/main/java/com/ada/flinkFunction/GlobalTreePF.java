...
import com.ada.model.GlobalToLocalInt;
...
public class GlobalTreePF extends ProcessWindowFunction<DensityToGlobalInt, GlobalToLocalInt, Integer, TimeWindow> {
    private int subTask;
    ...
    public void process(Integer key,
                        Context context,
                        Iterable<DensityToGlobalInt> elements,
                        Collector<GlobalToLocalInt> out) throws Exception {
...
//        }
        ...
        Iterator<DensityToGlobalInt> ite = elements.iterator();
        DensityToGlobalInt element = ite.next();
        int queryCount = 0;
        while (ite.hasNext()){
