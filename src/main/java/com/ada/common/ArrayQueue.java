...
public class ArrayQueue<E> extends AbstractCollection<E> implements Deque<E>, Cloneable, Serializable {
    /**
    ...
    static final class DeqSpliterator<E> implements Spliterator<E> {
        private final ArrayQueue<E> deq;
        private int fence;  // -1 until first use
        private int index;  // current index, modified on traverse/split

        /** Creates new spliterator covering the given array and range */
        DeqSpliterator(ArrayQueue<E> deq, int origin, int fence) {
            this.deq = deq;
            this.index = origin;
            this.fence = fence;
        }
